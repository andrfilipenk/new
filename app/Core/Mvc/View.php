...
class View implements ViewInterface
{
    ...
    protected function findTemplate(string $template): string
    {
        ...
        if (!file_exists($file)) {
            throw new ViewException("Template '{$template}' not found at: {$file}");
        }
        return $file;
    }
    ...
    public function endSection(): void
    {
        if ($this->activeSection === null) {
            throw new ViewException("Cannot end a section without starting one.");
        }
    ...
    public function __call(string $name, array $arguments)
    {
        ...
        throw new ViewException("Method or helper '{$name}' not found in View.");
    }
}